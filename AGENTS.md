...
It now includes versioned logo draft folders from `logo_v1` to `logo_v5`.

## PRINCIPLES

1. **First principles** — Start from the problem. Prefer the simplest thing that works.
2. **Code over docs** — If docs or anything else conflicts with the code, trust the code.
3. **Performance & UX first** — Prefer fast, smooth, user-friendly solutions.

## REPOSITORY FACTS

- Current working branch for this effort: `yaologo`.
- Root contents include `AGENTS.md`, `README.md`, `LICENSE`, `.gitignore`, and `logo_v1/` through `logo_v5/`.
